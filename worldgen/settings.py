"""
Django settings for worldgen project.
...
SECRET_KEY = 'django-insecure-t!jk)7pgmcsf9ulf_r6x$*c3f2n^31tla5x-1!=*s%rt(48tcq'
...
WSGI_APPLICATION = 'worldgen.wsgi.application'
